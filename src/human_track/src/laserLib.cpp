 ...
 */
void laserLib::getFeatures(vector<human_track::ClusteredScan> &clusterData)
{
 ...
 * */
void laserLib::features2ROS(vector<human_track::ClusteredScan> &clusterData)
{
 ...
 *  Must use loadScan() first.
 */
void laserLib::getClusters(vector<human_track::ClusteredScan> &clusterData)
{
